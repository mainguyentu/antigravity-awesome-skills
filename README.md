<!-- registry-sync: version=8.9.0; skills=1327; stars=27239; updated_at=2026-03-25T10:58:45+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,327+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More
...
- **Broad coverage with real utility**: 1,327+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [📚 Browse 1,327+ Skills](#browse-1327-skills)
...
If you want a faster answer than "browse all 1,327+ skills", start with a tool-specific guide:
